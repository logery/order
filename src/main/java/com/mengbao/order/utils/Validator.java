...
public class Validator {
	 ...
	 * 正则表达式：验证英文
	 */
	public static final String REGEX_ENG = "^[a-zA-z]{0,}$";
	 ...
	 * 正则表达式：验证数字，中，英文
	 */
	public static final String REGEX_NAME = "^[a-zA-Z0-9\u4e00-\u9fa5]{0,}$";
	 ...
	 * 正则表达式：验证特殊字符
	 */
	public static final String regEx="[^:\\\"<>\\|](\\x20|[^\\s\\\\/:\\*\\?\\\"<>\\|])*[^\\s\\\\/:\\*\\?\\\"<>\\|\\.]$";
	
	public static boolean includeSpecialCharacter(String input){
	...
	public static boolean isEnglish(String english){
		return Pattern.matches(REGEX_ENG, english);
	}
